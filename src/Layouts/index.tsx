...
import { useLocation } from '@reach/router'; // Get Current page Location
    ...
    <ThemeProvider theme={themes(theme, dir)}>
      <>
        ...
        <Layout evaIcons={icons} dir={dir} className={pageContext.layout === 'auth' ? 'auth-layout' : ''}>
          {/* {pageContext.layout !== 'auth' && pageContext.layout == '' && ( */}
            {pageContext.layout !== 'auth' && location.pathname !== '/' && (
            <Header
              dir={dir}
              changeDir={changeDir}
          ...
          <LayoutContainer>
            {pageContext.layout !== 'auth' && location.pathname !== '/' && <SidebarCustom ref={sidebarRef} />}
            {/* {pageContext.layout !== 'auth' && <SidebarCustom ref={sidebarRef} />} */}
            <LayoutContent>
              <LayoutColumns>
                <LayoutColumn className="main-content">{children}</LayoutColumn>
              </LayoutColumns>
              {pageContext.layout !== 'auth' && location.pathname !== '/' && <LayoutFooter>Footer</LayoutFooter>}
