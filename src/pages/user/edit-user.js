        ...
        <Card>
            <CardBody>
              ...
              <Container>
                  ...
                  <Row className="mb-5">
                    <Col breakPoint={{ xs: 12 }}>
                        <User name="Juanito Abelo" />
                    </Col>
                  </Row>

                  <Row className="justify-content-center align-items-center mb-5">
                    <Col className="col-lg-12">
                    { this.state.UserAddedState ? <div className="text-center text-success">Successfully Updating user Profile!</div> : null }
                    ...
                    <form>
                        ...
                        <Col breakPoint={{ xs: 12 }}>
                          ...
                          <Col breakPoint={{ xs: 12 }}>
                                <h2 className="text-center mb-5">ADMIN SECTION</h2> 
                          </Col>
